...
class GPAPI_API GpApiRqBaseDesc: public GpApiRqIfDesc
{
public:
    CLASS_DECLARE_DEFAULTS(GpApiRqBaseDesc)
    TYPE_STRUCT_DECLARE("e30c3a62-e95e-496a-abe2-370ff474aeca"_sv)

public:
                                GpApiRqBaseDesc     (void) noexcept;
    virtual                     ~GpApiRqBaseDesc    (void) noexcept override;
...
class PREFIX NAME##_rq final: public GpApiRqBaseDesc \
{ \
public: \
